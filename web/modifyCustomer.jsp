                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="${pageContext.request.contextPath}/customers/update" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="customer_type" name="customer_type" onchange="toggleCustomerType()" required>
                                                <option value="1" <c:if test="${customer.customerType == 1}">selected</c:if>>个人客户</option>
                                                <option value="2" <c:if test="${customer.customerType == 2}">selected</c:if>>企业客户</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="status" class="form-label">状态</label>
                                            <select class="form-select" id="status" name="status">
                                                <option value="1" <c:if test="${customer.status == 1}">selected</c:if>>活跃</option>
                                                <option value="0" <c:if test="${customer.status == 0}">selected</c:if>>停用</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="name" class="form-label">
                                                <span id="nameLabel">
                                                    <c:choose>
                                                        <c:when test="${customer.customerType == 2}">负责人姓名</c:when>
                                                        <c:otherwise>客户姓名</c:otherwise>
                                                    </c:choose>
                                                </span> 
                                    ...
                                    <!-- 企业客户专用字段 -->
                                    <div id="companyFields" <c:if test="${customer.customerType != 2}">style="display: none;"</c:if>>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="tel" class="form-control" id="phone" name="phone" 
                                                   value="${customer.phone}" placeholder="请输入电话号码">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="address" name="address" rows="3" 
                                                  placeholder="请输入详细地址...">${customer.address}</textarea>
                                    </div>
